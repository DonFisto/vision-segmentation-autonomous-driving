...
work_dir = '/home/danielmartinez/vision-segmentation-autonomous-driving/work_dirs/segformer_b0_cityscapes_carla_mixed_ft'
...
optim_wrapper = dict(
    optimizer=dict(type='AdamW', lr=4e-5, weight_decay=0.01)
)
