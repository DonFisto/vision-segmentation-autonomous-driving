...
load_from = '/home/danielmartinez/vision-segmentation-autonomous-driving/work_dirs/segformer_b0_signheavy_refine_8k/best_mIoU_iter_8000.pth'

work_dir = '/home/danielmartinez/vision-segmentation-autonomous-driving/work_dirs/segformer_b0_vruheavy_refine_8k'
...
param_scheduler = [
    dict(type='PolyLR', begin=0, end=8000, eta_min=1e-6, power=1.0, by_epoch=False)
]
